...
def save_outcome(
    ...
    table_names = ['vasopressor_durations', 'adenosine_durations', 'dobutamine_durations', 'dopamine_durations', 'epinephrine_durations', 'isuprel_durations', 
                    'milrinone_durations', 'norepinephrine_durations', 'phenylephrine_durations', 'vasopressin_durations']
...
if __name__ == '__main__':
    ...
    if (args['extract_pop'] == 0 | (args['extract_pop'] == 1) ) & isfile(os.path.join(outPath, static_filename)):
        ...
        select distinct i.subject_id, i.hadm_id, i.icustay_id,
            ...
            a.deathtime, i.ethnicity, a.admission_type, s.first_careunit,
