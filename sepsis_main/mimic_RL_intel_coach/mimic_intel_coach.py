...
task_parameters = TaskParameters(experiment_path='./tmp3', checkpoint_save_dir='./tmp3')
...
DATATSET_PATH = 'mimic_rl_rand_action.csv'
...
graph_manager = BatchRLGraphManager(agent_params=agent_params,
                                    ...
                                    vis_params=VisualizationParameters(tensorboard=True, dump_csv=True,dump_signals_to_csv_every_x_episodes=1),
